<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <select id="role" name="role" class="block appearance-none w-full bg-white border border-gray-300 rounded-md py-2 px-3 mt-1 focus:outline-none focus:border-indigo-500">
        ...
        <!-- contact -->
        <div class="mt-4">
            <x-input-label for="contact" :value="__('Contact Adress')" />
